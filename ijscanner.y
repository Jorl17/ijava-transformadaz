...
MethodDecl:		PUBLIC STATIC "(" MethodType ")" ID OCURV CCURV OBRACE CBRACE										{/*Zero repetitions of VarDecl and Statement*/}
	...
	|			PUBLIC STATIC "(" MethodType ")" ID OCURV FormalParams CCURV OBRACE 								{/*Same thing but now with FormalParams*/}
	...
	|			PUBLIC STATIC "(" MethodType ")" ID OCURV FormalParams CCURV OBRACE Go_Statement Go_VarDecl CBRACE  {/*1 or more repetitions of VarDecl and Statement*/}
	;
