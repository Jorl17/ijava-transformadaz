...
\item \textbf{Construção da árvore de sintaxe abstrata}, etapa que é realizada em simultâneo com a \emph{Análise Sintática}. A árvore de sintaxe abstrata irá representar o nosso programa a compilar, recorrendo a uma estrutura em árvore para representar as estruturas sintáticas das cadeias que o constituem.
...
FIXME: EXPLICAÇÂO BUE MERDOSA. MAXI VE ISTO E DIZ DE TUA JUSTIÇA!!!!! O CARDOSO CURTE BLICA!

\subsubsection{Expressões Indexáveis}

Indexável - Variaveis Indexaveis
